...
public class ConfigLoader extends ConfigurationCreator {
	...
	private void loadDefaultValues() {
		...
		if (get("Party.MaxPlayersPerParty.AddSlotsPermissions") == null) {
			set("Party.MaxPlayersPerParty.AddSlotsPermissions.Premium.Permission", "de.simonsator.bungeefriends.party.addslots.premium");
			set("Party.MaxPlayersPerParty.AddSlotsPermissions.Premium.SlotsToAdd", 5);
			set("Party.MaxPlayersPerParty.AddSlotsPermissions.SuperPremium.Permission", "de.simonsator.bungeefriends.party.addslots.premium");
		...
		set("Commands.Friends.TopCommands.MSG.MSGNonFriendsPermission", "de.simonsator.bungeefriends.msg.msgnonfriends");
		...
		set("Commands.Friends.SubCommands.Settings.Settings.PM.Priority", 3);
